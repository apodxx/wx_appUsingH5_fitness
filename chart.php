...
$sql = "SELECT type as 'name',sum(endTime-startTime) as 'value' FROM fitness_record  WHERE former='$_POST[FormerID]'  and endTime is not null and startTime > '$_POST[startTime]'  group by type";
// echo $sql;
